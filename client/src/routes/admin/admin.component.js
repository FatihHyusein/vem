            ...
            <div>
                <div style={{width: 256}}>
                    ...
                    >
                        ...
                        <Menu.Item key="2">
                            <Link to="/admin/roles"><Icon type="desktop"/> {!this.state.collapsed && 'RolesRoute'}</Link>
                        </Menu.Item>
                        <Menu.Item key="3">
                        ...
                        <Menu.Item key="4">
                            <Link to="/admin/vehicles"><Icon type="inbox"/> {!this.state.collapsed && 'VehiclesRoute'}</Link>
                        </Menu.Item>
                    </Menu>
                </div>
                <div>
